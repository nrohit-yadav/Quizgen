...
public class ComplexNumberMultiplicationProblem implements IPolynomialProblem{
	...
	public ComplexNumberMultiplicationProblem() {
	...
	public static void printProblemsWithMultipleChoiceAnswers(int count){
		...
		for(int k=0; k<count; k++){
			ComplexNumberMultiplicationProblem s = new ComplexNumberMultiplicationProblem();
